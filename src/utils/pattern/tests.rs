...
#[test]
fn test_pattern_forest_normalize_normalizes_pattern_forest_with_nested_pattern_nodes_and_empty_forests()
{
    let mut forest: PatternForest<i32> = PatternForest::Alt(Vec::new(), Some(3));
    assert_eq!(true, forest.add_node(PatternNode::new(1, PatternForests::Unfilled(Vec::new()))));
    let forest1: PatternForest<i32> = PatternForest::Alt(Vec::new(), Some(2));
    let mut forest2: PatternForest<i32> = PatternForest::Alt(Vec::new(), Some(2));
    assert_eq!(true, forest2.add_node(PatternNode::new(1, PatternForests::Unfilled(Vec::new()))));
    let mut forest3: PatternForest<i32> = PatternForest::Alt(Vec::new(), Some(2));
    assert_eq!(true, forest3.add_node(PatternNode::new(1, PatternForests::Unfilled(Vec::new()))));
    ...
    let mut forest4: PatternForest<i32> = PatternForest::Alt(Vec::new(), Some(2));
    assert_eq!(true, forest4.add_node(PatternNode::new(1, PatternForests::Unfilled(Vec::new()))));
    let forest5: PatternForest<i32> = PatternForest::Alt(Vec::new(), Some(2));
    let mut forest6: PatternForest<i32> = PatternForest::Alt(Vec::new(), Some(2));
    assert_eq!(true, forest6.add_node(PatternNode::new(1, PatternForests::Unfilled(Vec::new()))));
    assert_eq!(true, forest.add_node(PatternNode::new(2, PatternForests::Unfilled(vec![forest4, forest5, forest6]))));
    match forest.normalize() {
...
#[test]
fn test_pattern_forest_union_returns_new_forest_for_left_kind()
{
    // forest1
...
#[test]
fn test_pattern_forest_union_returns_new_forest_for_right_kind()
{
    // forest1
    let mut forest1: PatternForest<i32> = PatternForest::Alt(Vec::new(), Some(3));
    assert_eq!(true, forest1.add_node(PatternNode::new(1, PatternForests::Unfilled(Vec::new()))));
...
#[test]
fn test_pattern_forest_union_returns_new_forest_for_both_kind()
{
    // forest1
    let mut forest1: PatternForest<i32> = PatternForest::Alt(Vec::new(), Some(3));
    assert_eq!(true, forest1.add_node(PatternNode::new(1, PatternForests::Unfilled(Vec::new()))));
...
#[test]
fn test_pattern_forest_union_returns_new_forest_for_new_kind()
{
    // forest1
    let mut forest1: PatternForest<i32> = PatternForest::Alt(Vec::new(), Some(3));
    assert_eq!(true, forest1.add_node(PatternNode::new(1, PatternForests::Unfilled(Vec::new()))));
...
#[test]
fn test_pattern_forest_union_returns_new_forest_for_left_kind_and_right_kind()
{
    // forest1
    let mut forest1: PatternForest<i32> = PatternForest::Alt(Vec::new(), Some(3));
    assert_eq!(true, forest1.add_node(PatternNode::new(1, PatternForests::Unfilled(Vec::new()))));
...
#[test]
fn test_pattern_forest_union_returns_new_forest_for_nested_pattern_nodes()
{
    // forest1
    let mut forest1: PatternForest<i32> = PatternForest::Alt(Vec::new(), Some(3));
    assert_eq!(true, forest1.add_node(PatternNode::new(1, PatternForests::Unfilled(Vec::new()))));
...
#[test]
fn test_pattern_forest_union_returns_new_mixed_forest()
{
    // forest1
    let mut forest1: PatternForest<i32> = PatternForest::Alt(Vec::new(), Some(3));
    assert_eq!(true, forest1.add_node(PatternNode::new(1, PatternForests::Unfilled(Vec::new()))));
...
#[test]
fn test_pattern_forest_union_returns_new_forest_for_left_all()
{
    // forest1
    let forest1: PatternForest<i32> = PatternForest::All;
    // forest2
    let mut forest2: PatternForest<i32> = PatternForest::Alt(Vec::new(), Some(3));
    assert_eq!(true, forest2.add_node(PatternNode::new(1, PatternForests::Unfilled(Vec::new()))));
    let mut forest21: PatternForest<i32> = PatternForest::Alt(Vec::new(), Some(3));
...
#[test]
fn test_pattern_forest_union_returns_new_forest_for_right_all()
{
    // forest1
    let mut forest1: PatternForest<i32> = PatternForest::Alt(Vec::new(), Some(3));
    assert_eq!(true, forest1.add_node(PatternNode::new(1, PatternForests::Unfilled(Vec::new()))));
    ...
    assert_eq!(true, forest1.add_node(PatternNode::new(2, PatternForests::Unfilled(vec![forest11, forest12, forest13]))));
    // forest2
    let forest2: PatternForest<i32> = PatternForest::All;
    match forest1.union(&forest2) {
        Ok((kind3, forest3)) => {
            assert_eq!(PatternKind::Right, kind3);
            match forest3 {
...
#[test]
fn test_pattern_forest_union_returns_new_forest_for_both_all()
{
    // forest1
    let forest1: PatternForest<i32> = PatternForest::All;
    // forest2
...
#[test]
fn test_pattern_forest_intersection_returns_new_forest()
{
    // forest1
    let mut forest1: PatternForest<i32> = PatternForest::Alt(Vec::new(), Some(3));
    assert_eq!(true, forest1.add_node(PatternNode::new(1, PatternForests::Unfilled(Vec::new()))));
    ...
    let mut forest12: PatternForest<i32> = PatternForest::Alt(Vec::new(), Some(3));
    assert_eq!(true, forest12.add_node(PatternNode::new(2, PatternForests::Unfilled(Vec::new()))));
    assert_eq!(true, forest12.add_node(PatternNode::new(3, PatternForests::Unfilled(Vec::new()))));
    let mut forest13: PatternForest<i32> = PatternForest::Alt(Vec::new(), Some(3));
    assert_eq!(true, forest13.add_node(PatternNode::new(1, PatternForests::Unfilled(Vec::new()))));
    assert_eq!(true, forest13.add_node(PatternNode::new(2, PatternForests::Unfilled(Vec::new()))));
    assert_eq!(true, forest1.add_node(PatternNode::new(2, PatternForests::Unfilled(vec![forest11, forest12, forest13]))));
    ...
    let mut forest22: PatternForest<i32> = PatternForest::Alt(Vec::new(), Some(3));
    assert_eq!(true, forest22.add_node(PatternNode::new(1, PatternForests::Unfilled(Vec::new()))));
    assert_eq!(true, forest22.add_node(PatternNode::new(3, PatternForests::Unfilled(Vec::new()))));
    let mut forest23: PatternForest<i32> = PatternForest::Alt(Vec::new(), Some(3));
    assert_eq!(true, forest23.add_node(PatternNode::new(1, PatternForests::Unfilled(Vec::new()))));
    assert_eq!(true, forest23.add_node(PatternNode::new(2, PatternForests::Unfilled(Vec::new()))));
    assert_eq!(true, forest2.add_node(PatternNode::new(2, PatternForests::Unfilled(vec![forest21, forest22, forest23]))));
    match forest1.intersection(&forest2) {
        Ok(forest3) => {
            match forest3 {
                PatternForest::Alt(nodes, Some(3)) => {
                    assert_eq!(2, nodes.len());
...
#[test]
fn test_pattern_forest_intersection_returns_new_forest_for_nested_pattern_nodes()
{
    // forest1
    let mut forest1: PatternForest<i32> = PatternForest::Alt(Vec::new(), Some(3));
    assert_eq!(true, forest1.add_node(PatternNode::new(1, PatternForests::Unfilled(Vec::new()))));
...
#[test]
fn test_pattern_forest_intersection_returns_new_mixed_forest()
{
    // forest1
    let mut forest1: PatternForest<i32> = PatternForest::Alt(Vec::new(), Some(3));
    assert_eq!(true, forest1.add_node(PatternNode::new(1, PatternForests::Unfilled(Vec::new()))));
...
#[test]
fn test_pattern_forest_intersection_returns_new_forest_for_left_all()
{
    // forest1
    let forest1: PatternForest<i32> = PatternForest::All;
    // forest2
...
#[test]
fn test_pattern_forest_intersection_returns_new_forest_for_right_all()
{
    // forest1
    let mut forest1: PatternForest<i32> = PatternForest::Alt(Vec::new(), Some(3));
    assert_eq!(true, forest1.add_node(PatternNode::new(1, PatternForests::Unfilled(Vec::new()))));
...
#[test]
fn test_pattern_forest_intersection_returns_new_forest_for_both_all()
{
    // forest1
    let forest1: PatternForest<i32> = PatternForest::All;
    // forest2
...
#[test]
fn test_union_pattern_nodes_returns_pattern_nodes_for_right_filled_forests_and_left_kind_and_right_kind()
{
    let mut forest11: PatternForest<i32> = PatternForest::Alt(Vec::new(), Some(3));
    assert_eq!(true, forest11.add_node(PatternNode::new(1, PatternForests::Unfilled(Vec::new()))));
    assert_eq!(true, forest11.add_node(PatternNode::new(2, PatternForests::Unfilled(Vec::new()))));
    ...
    let mut forest13: PatternForest<i32> = PatternForest::Alt(Vec::new(), Some(3));
    assert_eq!(true, forest13.add_node(PatternNode::new(2, PatternForests::Unfilled(Vec::new()))));
    assert_eq!(true, forest13.add_node(PatternNode::new(3, PatternForests::Unfilled(Vec::new()))));
    let node1 = Rc::new(RefCell::new(PatternNode::new(1, PatternForests::Unfilled(vec![forest11, forest12, forest13]))));
    let mut forest2: PatternForest<i32> = PatternForest::Alt(Vec::new(), Some(3));
    assert_eq!(true, forest2.add_node(PatternNode::new(1, PatternForests::Unfilled(Vec::new()))));
    assert_eq!(true, forest2.add_node(PatternNode::new(2, PatternForests::Unfilled(Vec::new()))));
    let node2 = Rc::new(RefCell::new(PatternNode::new(1, PatternForests::Filled(forest2, 3))));
    match union_pattern_nodes(&node1, &node2) {
        Ok(pairs) => {
            assert_eq!(2, pairs.len());
            match &pairs[0] {
                (kind, node) => {
                    assert_eq!(PatternKind::Left, *kind);
                    let node_r = node.borrow();
                    assert_eq!(1, *node_r.id());
                    match node_r.forests() {
                        PatternForests::Unfilled(forests) => {
                            match &forests[0] {
                                PatternForest::Alt(nodes, Some(3)) => {
                                    assert_eq!(2, nodes.len());
            ...
            match &pairs[1] {
                (kind, node) => {
                    assert_eq!(PatternKind::Right, *kind);
                    let node_r = node.borrow();
                    assert_eq!(1, *node_r.id());
                    match node_r.forests() {
...
#[test]
fn test_union_pattern_nodes_returns_pattern_nodes_for_right_filled_forests_and_left_kind()
{
    let mut forest11: PatternForest<i32> = PatternForest::Alt(Vec::new(), Some(3));
    assert_eq!(true, forest11.add_node(PatternNode::new(1, PatternForests::Unfilled(Vec::new()))));
    assert_eq!(true, forest11.add_node(PatternNode::new(2, PatternForests::Unfilled(Vec::new()))));
...
#[test]
fn test_union_pattern_nodes_returns_pattern_nodes_for_left_filled_forests_and_left_kind_and_right_kind()
{
    let mut forest1: PatternForest<i32> = PatternForest::Alt(Vec::new(), Some(3));
    assert_eq!(true, forest1.add_node(PatternNode::new(1, PatternForests::Unfilled(Vec::new()))));
    assert_eq!(true, forest1.add_node(PatternNode::new(2, PatternForests::Unfilled(Vec::new()))));
    let node1 = Rc::new(RefCell::new(PatternNode::new(1, PatternForests::Filled(forest1, 3))));
    let mut forest21: PatternForest<i32> = PatternForest::Alt(Vec::new(), Some(3));
    assert_eq!(true, forest21.add_node(PatternNode::new(1, PatternForests::Unfilled(Vec::new()))));
    assert_eq!(true, forest21.add_node(PatternNode::new(2, PatternForests::Unfilled(Vec::new()))));
    let mut forest22: PatternForest<i32> = PatternForest::Alt(Vec::new(), Some(3));
    ...
    let mut forest23: PatternForest<i32> = PatternForest::Alt(Vec::new(), Some(3));
    assert_eq!(true, forest23.add_node(PatternNode::new(2, PatternForests::Unfilled(Vec::new()))));
    assert_eq!(true, forest23.add_node(PatternNode::new(3, PatternForests::Unfilled(Vec::new()))));
    let node2 = Rc::new(RefCell::new(PatternNode::new(1, PatternForests::Unfilled(vec![forest21, forest22, forest23]))));
    match union_pattern_nodes(&node1, &node2) {
        Ok(pairs) => {
            assert_eq!(2, pairs.len());
            match &pairs[0] {
...
#[test]
fn test_union_pattern_nodes_returns_pattern_nodes_for_left_filled_forests_and_right_kind()
{
    let mut forest1: PatternForest<i32> = PatternForest::Alt(Vec::new(), Some(3));
    assert_eq!(true, forest1.add_node(PatternNode::new(1, PatternForests::Unfilled(Vec::new()))));
    let node1 = Rc::new(RefCell::new(PatternNode::new(1, PatternForests::Filled(forest1, 3))));
...
#[test]
fn test_union_pattern_nodes_returns_pattern_nodes_for_both_filled_forests()
{
    let mut forest1: PatternForest<i32> = PatternForest::Alt(Vec::new(), Some(3));
    assert_eq!(true, forest1.add_node(PatternNode::new(1, PatternForests::Unfilled(Vec::new()))));
    assert_eq!(true, forest1.add_node(PatternNode::new(2, PatternForests::Unfilled(Vec::new()))));
    ...
    let mut forest2: PatternForest<i32> = PatternForest::Alt(Vec::new(), Some(3));
    assert_eq!(true, forest2.add_node(PatternNode::new(1, PatternForests::Unfilled(Vec::new()))));
    assert_eq!(true, forest2.add_node(PatternNode::new(3, PatternForests::Unfilled(Vec::new()))));
    let node2 = Rc::new(RefCell::new(PatternNode::new(1, PatternForests::Filled(forest2, 3))));
    match union_pattern_nodes(&node1, &node2) {
        Ok(pairs) => {
            assert_eq!(1, pairs.len());
            match &pairs[0] {
                (kind, node) => {
                    assert_eq!(PatternKind::New, *kind);
                    let node_r = node.borrow();
                    assert_eq!(1, *node_r.id());
                    match node_r.forests() {
                        PatternForests::Filled(forest, len) => {
...
#[test]
fn test_intersection_pattern_nodes_returns_pattern_node_for_right_filled_forests()
{
    let mut forest11: PatternForest<i32> = PatternForest::Alt(Vec::new(), Some(3));
    assert_eq!(true, forest11.add_node(PatternNode::new(1, PatternForests::Unfilled(Vec::new()))));
    assert_eq!(true, forest11.add_node(PatternNode::new(2, PatternForests::Unfilled(Vec::new()))));
...
#[test]
fn test_intersection_pattern_nodes_returns_pattern_node_for_left_filled_forests()
{
    let mut forest1: PatternForest<i32> = PatternForest::Alt(Vec::new(), Some(3));
    assert_eq!(true, forest1.add_node(PatternNode::new(1, PatternForests::Unfilled(Vec::new()))));
    assert_eq!(true, forest1.add_node(PatternNode::new(2, PatternForests::Unfilled(Vec::new()))));
...
#[test]
fn test_intersection_pattern_nodes_returns_pattern_node_for_both_filled_forests()
{
    let mut forest1: PatternForest<i32> = PatternForest::Alt(Vec::new(), Some(3));
    assert_eq!(true, forest1.add_node(PatternNode::new(1, PatternForests::Unfilled(Vec::new()))));
    assert_eq!(true, forest1.add_node(PatternNode::new(2, PatternForests::Unfilled(Vec::new()))));
